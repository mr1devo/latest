...
import './Style.css';
import './fonts.css'; // Import the fonts.css file here
    ...
    return (
        <div className="Home" style={{ backgroundColor: '#ffffff' }}>
            ...
            <div className="second">
                <br />
                <br />
                {/* Apply the gradient style to the h1 element */}
                <h1 className="gradient-text">Where to ?</h1><br/><br/><div align='center'>
<Searchbar/></div><br /><br />
<Works /><br /><br />
